...
class App extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      employees: [], attributes: [], page: 1, pageSize: 5, links: {}
...
class UpdateDialog extends React.Component {
  ...
  render() {
    ...
    const isManagerCorrect = this.props.employee.entity.manager.name
        == this.props.loggedInManager;
...
class EmployeeList extends React.Component {
  ...
  handleInput(e) {
    ...
    if (/^[0-9]+$/.test(pageSize)) {
      ...
      ReactDOM.findDOMNode(this.refs.pageSize).value = pageSize.substring(0,
          pageSize.length - 1);
    }
  }
  ...
  render() {
    const pageInfo = this.props.page.hasOwnProperty("number") ?
        <h3>Employees - Page {this.props.page.number
        + 1} of {this.props.page.totalPages}</h3> : null;
