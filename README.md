...
| 기간            | 주제             | 내용                                                                                                     |
| --------------- | ---------------- | -------------------------------------------------------------------------------------------------------- |
| 2022.06~        | 개발방법론       | TDD, DDD, CI/CD, Serverless, NoSQL                                                                       |
| 2022.03~        | 프로젝트         | [(가칭) FOR PHOTOGRAPHER LIFE](https://github.com/platanus-kr/lilfoto) 프로젝트                          |
| 2022.02~2022.03 | Spring 심화      | 이펙티브 자바 3/E, 토비의 스프링                                                                         |
| 2021.12~2021.02 | JS, SQL 기본     | Javascript ES6, jQuery, SQL, Query tuning                                                                |
| 2021.11~2022.02 | 인턴             | **스타트업 이커머스 인턴**                                                                               |
...
- [스프링으로 하는 마이크로서비스 구축 Hands-On Microservices with Spring Boot and Spring Cloud](http://www.acornpub.co.kr/book/microservices-spring) (Magnus Larsson, 에이콘)
- [토비의 스프링 3.1](http://www.acornpub.co.kr/book/toby-spring3-1-set) (이일민, 에이콘)
- [스프링 인 액션 Spring in Action](https://jpub.tistory.com/539) (Craig Walls, 제이펍)
...
- 실용주의 프로그래머 The Pragmatic Programmer (David Thomas, Andrew Hunt, 인사이트)
...
- [Plata Board](https://github.com/platanus-kr/spring-boot-webboard) (Spring Boot + JDBC + MyBatis 프로젝트 : 게시판 웹 서비스)
- [(가칭) FOR PHOTOGRAPHER LIFE](https://github.com/platanus-kr/lilfoto) (Spring Boot, React, Spring Data JPA, Redis, Spring Cloud..)
